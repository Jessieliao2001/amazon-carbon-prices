...
prediction.1043SitesModel <- purrr::map_df(
  .x = aux.prices,
  .f = ~ {
    file_path <- here::here("output/optimization/hmc/gurobi/1043sites/xi_0.5/pa_41.11",
                            paste0("pe_", .x, "/Z.txt"))
...
# GENERATE MAPS
dir.create(here::here("plots/1043-hmc_xi05"), recursive = TRUE, showWarnings = FALSE)

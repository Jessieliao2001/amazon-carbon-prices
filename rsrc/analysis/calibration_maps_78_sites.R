...
load(here::here("data/calibration/", "calibration_78_sites.Rdata"))

# AMAZON BIOME VECTOR DATA
load(here::here("data/clean/amazon_biome.Rdata"))

productivity_params <- read.csv(here::here("data/calibration/", "productivity_params_78.csv"))%>%
...
ggplot2::ggsave(filename = here::here("plots/calibration/78SitesModel/map_z2017_78Sites.png"), plot = plot, width = 8, height = 6)
...
ggplot2::ggsave(filename = here::here("plots/calibration/78SitesModel/map_zbar_2017.png"), plot = plot, width = 8, height = 6)
...
ggplot2::ggsave(filename = here::here("plots/calibration/78SitesModel/map_z2017Share_78Sites.png"), plot = plot, width = 8, height = 6)

# # A_2017
# plot<-ggplot2::ggplot(data = calib_df %>%
#                   dplyr::mutate(A_2017 = (z_2017*theta_78Sites*p_mean)/1000,
...
# ggplot2::ggsave(filename = here::here("plots/calibration/78SitesModel/map_A2017_78Sites.png"), plot=plot, width = 8, height = 6)
...
ggplot2::ggsave(filename = here::here("plots/calibration/78SitesModel/map_x2017_78Sites.png"), plot = plot, width = 8, height = 6)
...
ggplot2::ggsave(filename = here::here("plots/calibration/78SitesModel/map_gamma_78Sites.png"), plot = plot, width = 8, height = 6)
...
ggplot2::ggsave(filename = here::here("plots/calibration/78SitesModel/map_theta_78Sites.png"), plot = plot, width = 8, height = 6)

...
EXHIBITS = [
    ...
    },
    {
        ...
        "output_pattern": "output/mpc/day0_present_value_mpc_b0_sites78_xi_*_unconstrained.tex",
        "program": "python pysrc/mpc/mpc_compute_day0.py --model unconstrained --b 0 --xi all",
        "status_note": "derived from MPC day-0 optimization outputs",
    },
    {
        "exhibit": "Table 7",
        "kind": "table",
    ...
    },
    {
        ...
        "output_pattern": "output/mpc/day0_present_value_mpc_b15_sites78_xi_*_unconstrained.tex",
        "program": "python pysrc/mpc/mpc_compute_day0.py --model unconstrained --b 15 --xi all",
        "status_note": "derived from MPC day-0 optimization outputs",
    },
    {
        "exhibit": "Table 9",
    ...
    },
    {
        ...
        "output_pattern": "output/mpc/day0_present_value_mpc_b*_sites78_xi_*_constrained.tex",
        "program": "python pysrc/mpc/mpc_compute_day0.py --model constrained --b all --xi all",
        "status_note": "derived from MPC day-0 optimization outputs",
    },
    {
        "exhibit": "Table 13",
    ...
    },
    {
        ...
        "program": "python pysrc/mpc/mpc_compute_day0.py; python pysrc/mpc/mpc_compute.py --model unconstrained --b 0 10 15 25 --xi inf --mode baseline",
        "status_note": "initial-period rows use day-0 outputs; simulation rows use MPC simulation outputs",
    },
    {
        "exhibit": "Table 19",
        "kind": "table",
        "description": "MPC decomposition for b=10",
        "output_pattern": "output/mpc/day0_present_value_mpc_b10_sites78_xi_*_unconstrained.tex",
        "program": "python pysrc/mpc/mpc_compute_day0.py --model unconstrained --b 10 --xi all",
        "status_note": "derived from MPC day-0 optimization outputs",
    },
    {
        "exhibit": "Table 20",
    ...
    },
    {
        ...
        "output_pattern": "output/mpc/day0_present_value_mpc_b25_sites78_xi_*_unconstrained.tex",
        "program": "python pysrc/mpc/mpc_compute_day0.py --model unconstrained --b 25 --xi all",
        "status_note": "derived from MPC day-0 optimization outputs",
    },
    {
        "exhibit": "Table 22",

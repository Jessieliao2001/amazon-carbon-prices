...
#SBATCH --job-name=mpc_check
#SBATCH --output=./job-outs/mpc_check/run.out
#SBATCH --error=./job-outs/mpc_check/run.err
...
python3 -u /project/lhansen/HMC_rep26_robust_mac/amazon-carbon-prices/scripts/mpc_check.py

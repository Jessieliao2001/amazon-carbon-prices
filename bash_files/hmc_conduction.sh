...
#SBATCH --job-name=conduction_hmc
#SBATCH --output=./job-outs/conduction_hmc/run.out
#SBATCH --error=./job-outs/conduction_hmc/run.err
...
python3 -u pysrc/scripts/conduction_hmc.py

...
#SBATCH --job-name=mpc_errorcheck
#SBATCH --output=./job-outs/mpc_errorcheck/run.out
#SBATCH --error=./job-outs/mpc_errorcheck/run.err
...
python3 -u /project/lhansen/HMC_rep26_robust_mac/amazon-carbon-prices/scripts/mpc_errorcheck.py

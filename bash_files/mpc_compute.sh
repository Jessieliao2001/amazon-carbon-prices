...
#SBATCH --job-name=mpc_compute
#SBATCH --output=./job-outs/mpc_compute/run.out
#SBATCH --error=./job-outs/mpc_compute/run.err
...
python3 -u /project/lhansen/HMC_rep26_robust_mac/amazon-carbon-prices/pysrc/mpc/mpc_compute.py

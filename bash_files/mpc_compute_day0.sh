...
#SBATCH --job-name=mpc_compute_day0
#SBATCH --output=./job-outs/mpc_compute_day0/run.out
#SBATCH --error=./job-outs/mpc_compute_day0/run.err
...
python3 -u /project/lhansen/HMC_rep26_robust_mac/amazon-carbon-prices/pysrc/mpc/mpc_compute_day0.py

...
usage() {
    echo "Usage: bash_files/mpc_hmc.sh <local|slurm> <all|pre|formal|figure14|day0> [run.sh options]"
    echo
    echo "Stages:"
...
case "$STAGE" in
    pre)
        ...
        ;;
    figure14)
        STEPS=(mpc-hmc-figure14)
        ;;
    day0)
        STEPS=(mpc-day0)
        ;;
    formal)
        STEPS=(mpc-hmc-figure14 mpc-day0)
        ;;
    all)
        STEPS=(mpc-hmc-pre mpc-hmc-figure14 mpc-day0)
        ;;
    *)
        usage
        exit 2
